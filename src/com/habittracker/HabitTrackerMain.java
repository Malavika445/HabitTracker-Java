...
public class HabitTrackerMain {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
        	...
        	System.out.println("3. Update Habit Status");
 ...
 // -------- Update Habit Status --------
    public static void updateHabit(Scanner sc) {

        System.out.print("Enter Habit ID to update: ");
        int id = sc.nextInt();
        sc.nextLine();

        System.out.print("Enter new status (Completed / Pending): ");
        String status = sc.nextLine();

        try {
            Connection con = DBConnection.getConnection();
            String sql = "UPDATE habits SET status = ? WHERE id = ?";
            ...
            if (rows > 0) {
                ...
                System.out.println("Habit ID not found.");
            }
 ...
 // -------- Delete Habit --------
    public static void deleteHabit(Scanner sc) {
